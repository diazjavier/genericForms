  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <Link href="/pages/new/TiposDeMovimientosStock">
            Alta de Tipos de Movimeinto de Stock
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link href="/pages/dataTablePage/Usuarios">Ejemplo de DataTable: Usuarios</Link>
        </li>
        <li>
          <Link href="/pages/dataTablePage/MediosDePago">Ejemplo de DataTable: Medios de Pago</Link>
        </li>
      </ul>
    </div>
  );
